...
{
    public class M3uDownloaderClient : IM3uDownloader
    {
        ...
        internal M3uDownloaderClient(string url, IEnumerable<IReader> readers)
        {        
        ...
        private DownloadService GetDownloadeService()
        {
            ...
            downloadService.ChunkDownloadProgressChanged += (object? sender, Downloader.DownloadProgressChangedEventArgs e) => OnChunkDownloadProgressChanged(e.ReceivedBytes);
